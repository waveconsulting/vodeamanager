...
class Constant
{
    ...
    const NUMBER_SETTING_RESET_TYPE_YEARLY = 'YEAR';
    ...
    const NUMBER_SETTING_RESET_TYPE_OPTIONS = [
        ...
        self::NUMBER_SETTING_RESET_TYPE_YEARLY => 'Yearly',
    ];

    const NUMBER_SETTING_COMPONENT_TYPE_TEXT = 'TEXT';
    ...
    const NUMBER_SETTING_COMPONENT_TYPE_OPTIONS = [
        self::NUMBER_SETTING_COMPONENT_TYPE_TEXT => 'Text',
